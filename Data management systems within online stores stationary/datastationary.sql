...
--
-- Host: 127.0.0.1
-- Generation Time: May 27, 2020 at 01:17 PM
...
CREATE TABLE `customer` (
  ...
  `Customer_Email` varchar(50) COLLATE utf8_thai_520_w2 NOT NULL
...
INSERT INTO `customer_email` (`Customer_code`, `Customer_Email`) VALUES
('610055', 'natkanoksoung99@gmail.com'),
('610812', 'cream@hotmail.com'),
('610830', 'com@hotmail.com'),
('610832', 'momantra00@gmail.com'),
('610837', 'na2709@gmail.com');
...
INSERT INTO `customer_tel` (`Customer_code`, `Customer_Tel`) VALUES
('610837', '0851429335'),
('610832', '0891304660'),
('610055', '0905519624'),
('610812', '0950282111'),
...
CREATE TABLE `product` (
  ...
  `Type_id` varchar(10) COLLATE utf8_thai_520_w2 NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_thai_520_w2;
...
INSERT INTO `product` (`Product_Code`, `Product_Name`, `Product_Price`, `Product_Detail`, `Product_Stock`, `Product_Brand`, `Type_id`) VALUES
...
INSERT INTO `product_purchase` (`Product_Code`, `Purchase_Code`) VALUES
('', ''),
('', ''),
('A001', 'PCH0001'),
('A006', 'PCH0002'),
...
INSERT INTO `purchaseorder` (`Purchase_Code`, `Date_BuyProduct`, `Quantity_Product`, `Customer_Code`, `Pay_ID`, `Trans_Code`) VALUES
('PCH0001', '2020-02-27', 2, '610055', 'XX0001', 'K0001TH'),
('PCH0002', '2020-03-11', 1, '610832', 'XX0002', 'P0002TH'),
('PCH0003', '2020-04-22', 5, '610837', 'XX0003', 'K0001TH'),
('PCH0004', '2020-05-01', 10, '610812', 'XX0004', 'K0001TH');
...
--
ALTER TABLE `product`
  ADD CONSTRAINT `product_ibfk_1` FOREIGN KEY (`Type_id`) REFERENCES `producttype` (`Type_Code`);
...
ALTER TABLE `purchaseorder`
  ...
  ADD CONSTRAINT `purchaseorder_ibfk_4` FOREIGN KEY (`Pay_ID`) REFERENCES `payment` (`Pay_ID`);
COMMIT;
